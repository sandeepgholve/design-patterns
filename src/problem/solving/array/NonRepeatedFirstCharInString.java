 ...
 * Read more: https://javarevisited.blogspot.com/2014/03/3-ways-to-find-first-non-repeated-character-String-programming-problem.html#ixzz5JzxoqbNA
 */
public class NonRepeatedFirstCharInString {
    public static void main(String[] args) {
        String[] inputArr = {"hello", "swiss"};
